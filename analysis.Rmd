...
In what concerns the distribution of speeches per party, we expected MDB, PODEMOS, and PSD to have a higher number of speeches, as they account for a larger percentage of the Senate House. What we find out is that PT, with only 6 Senators (8% of the Senate House) has 1097 speeches (21% of the speeches). PT was the runner-off party of the 2018 elections and was the party elected for the presidential elections of 2002, 2006, 2010, and 2014. This finding might indicate a higher opposition to Bolsonaro's agenda within the Senate corpus.
...
We initially consulted the  “LexiCoder Policy Agenda” dictionary to have a baseline for words that could capture these main topics. We then translated the words to Portuguese and adapted them for the Brazilian context. 
...
The graph displays words that push a document farthest to the left or the right. Words located in the bottom are used less frequently. Right and left word positions (beta) range from approximately -2.5 to 2. 
