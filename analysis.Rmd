...
The graph illustrates the party positions from the Presidential corpus (Y-axis) and the Senate corpus (X-axis). 
...
```{r}
# Select words for graph
words_genfam <- c('kit gay', 'tradicional', 'mulher', 'gênero', 'sexo', 'homem', 'feminis*', 'juventude', 'gay', 'jovem', 'jovens', 'família', 'sexista', 'resistência', 'direito', 'crianças', 'mãe*', 'pai', 'justiça', 'feminina', 'marido', 'esposa', 'casal')
