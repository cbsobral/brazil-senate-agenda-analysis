...
```{r}
# dictionary
# from "dictionaries/policy_agendas_english.RData"
econ.lexicon <- dictionary(list(economy = c('econom*', 'desempreg*', 'inflação', 'demanda', 'oferta', 'negócios', 'empreg*', 'preço*', 'banco', 'dinheiro', 'gastos', 'dívida', 'juro*', 'controle', 'custo*', 'produtividade', 'índice', 'renda', 'pib', 'produto', 'bruto', 'empreg*', 'trabalh*', 'privat*')))



dfmat_econ <- dfm(corp_sen, groups = "Partido", dictionary = econ.lexicon)
dfmat_econ.prop <- dfm_weight(dfmat_econ, scheme = "prop")
convert(dfmat_econ.prop, "data.frame")
```
